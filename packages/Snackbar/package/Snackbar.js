...
var Snackbar = function (props, ref) {
    ...
    var _a = React.useState({ isVisible: false, isShowing: false }), showingState = _a[0], setShowingState = _a[1];
    var _b = React.useState({ text: '', timer: Timer.SHORT }), content = _b[0], setContent = _b[1];
    var text = content.text, actionText = content.actionText, messageStyle = content.messageStyle, actionStyle = content.actionStyle, containerStyle = content.containerStyle, _c = content.timer, timer = _c === void 0 ? Timer.SHORT : _c, onPressAction = content.onPressAction;
    var isShowing = showingState.isShowing, isVisible = showingState.isVisible, timeout = showingState.timeout;
