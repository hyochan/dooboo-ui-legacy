...
describe('[DataTable] render test', (): void => {
  it('should render without crashing', () => {
    props = createTestProps();
    component = <DataTable {...props} {...initialProps} />;
  ...
  it('should hide [Checkbox] when isCheckAble is (false or undefined.)', () => {
    const { queryByTestId } = render(
      <DataTable {...props} {...initialProps} isCheckAble={false} />,
    );
  ...
  it('should show [Checkbox] when isCheckAble is (true.)', () => {
    const { getAllByTestId } = render(
      <DataTable {...props} {...initialProps} isCheckAble={true} />,
    );
